...
namespace ProgressiveTaxCalculator.Sandbox.DatabaseTools.GenerateDataValues.Implementation
{
    public static class GenerateDataValues
    {
        public static List<TaxType> GenerateSampleTaxType()
        {
        ...
        public static List<TaxTerm> GenerateSampleTaxTerm() 
        {
        ...
        public static List<PostalCode> GenerateSamplePostalCode() 
        {
        ...
        public static List<TaxTable> GenerateSampleTaxTable() 
        {
